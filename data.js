...
const data = {
  ...
  signos: [{
    ...
    text: [
      ...
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro. As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua.
      ...
      Muitas vezes comporta-se de maneira precipitada ou agressiva, sem levar em consideração as consequências de seus atos. Pode ter súbitos acessos de raiva que, no entanto, são passageiros e logo esquecidos. Sente urgência em tudo.
      A pessoa com esta posição da Lua prefere a autonomia e é muito independente. Insiste em seguir o seu próprio curso de ação, certo ou errado. Não tolera a interferência dos outros e costuma reagir mal quando depende de alguém para alguma coisa.
      Tende a considerar a reação dos outros de maneira pessoal e a dominar os outros emocionalmente. Num relacionamento, o que lhe interessa é a conquista. Por tudo isso, é importante aprender a equilibrar suas imposições com mais ternura, cordialidade e suavidade.`,
