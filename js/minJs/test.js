...
var returnedModule = function returnedModule(options) {
  _this.options = Object.assign({}, defaults, options);

  _this.setOptions = function (options) {
    this.options = Object.assign({}, this.options, options);
    return this;
  }.bind(_this); // Loglal part
  //-------------------------------------------------------------------------
  ...
  var docQuery = function docQuery(elem) {
  ...
  var $inputSignoOrCasa = function $inputSignoOrCasa(elem) {
    return docQuery(elem);
  };

  var $resetInput = function $resetInput(elem) {
    return docQuery(elem);
  };

  var $printButton = function $printButton(elem) {
    return docQuery(elem);
  };
  ...
  var criarEl = function criarEl(elType, assignmentReference, klass, id, selectorElem, functiontextEl, el) {
  ...
  var storeIndexOrText = function storeIndexOrText(elem) {
    elems = [];
  ...
  var storeIndexAndText = function storeIndexAndText(elem1, functionelem2, elems) {
    elem1 = [];
    elem2 = [];
    elems = {};
  ...
  var defineSelectedIndexInAnArray = function defineSelectedIndexInAnArray(functiontextOfElem, indexOfElem) {
    var valueToReturn = "";
  ...
  var defineNodosLunaresTitle = function defineNodosLunaresTitle(functionelemToActUpon, idx) {
  ...
  var defineTitles = function defineTitles(functionelemToActUpon, indexPassedIn) {
  ...
  var grabInputValues = function grabInputValues(functionelement, index) {
  ...
  var setUpTextForTemplate = function setUpTextForTemplate(indexSelectedArray) {
  ...
  var devareTextBlock = function devareTextBlock(ev) {
  ...
  var addElementsToTemplate = function addElementsToTemplate() {
    console.log('addElementsToTemplate is running sound');
    var elemPlaceholder = []; // Use the criarEl method to create this one
    // ------------------------------------------------------
    ...
    var getSelectedIndexInArray = defineSelectedIndexInAnArray(true, true); // Used in the function bellow
    ...
    for (var z = 0; z < templateArray.length; z++) {
      if (siteLists.first.link.selectedIndex === 0) {
        ...
        if (siteLists.first.link.selectedIndex !== 0 && siteLists.second.link.selectedIndex === 0 && siteLists.third.link.selectedIndex === 0) {
          ...
          docQuery('div[class^=textBlockWrapper-]:last-child').querySelector('.arrayKlass').innerHTML = elemPlaceholder[1]; // .classList.add('lastBlockOfArray');
  ...
  var checkEmptyTextBlock = function checkEmptyTextBlock(elem) {
  ...
  var fillFormIn = function fillFormIn(Obj, listNumber) {
    var treatedTitle = '';
  ...
  _this.init = function () {
    ...
    $submitBtn.addEventListener('click', addElementsToTemplate); // Control the buttons' behaviour
    // ------------------------------------------------------------------------------------------
