...
const data = {
  ...
  },
  {
    title: `leao`,
    text: [
      `Leão é um signo de Fogo, está relacionado ao entusiasmo e poder de liderança. Quem nasce com o Sol em Leão é portador de uma força comparável aos planetas que giram em volta do Sol. Suas atitudes refletem seu potencial luminoso, confiante e criativo. Seu reino é o reino do coração, das emoções e dos sentimentos dramáticos.
      ...
      O Sol em Leão predispõe o nativo para as artes visuais (cinema, teatro, estética, moda, televisão, etc.) e para a política. Há grande probabilidade de obter êxito e sucesso através de suas qualidades de liderança. O Leonino é namorador e gosta de conquistas amorosas.
      ...
      Na saúde, deve prestar especial atenção às suas partes vulneráveis: o coração, as artérias e as veias, o sangue e a circulação sanguínea, as costas, a coluna vertebral, o plexo solar, o baço e o pâncreas. Deve também prestar atenção especial aos olhos.
      Apesar da sua enorme resistência, pode acontecer que o fique doente. Neste caso, tende a ficar impaciente e quer curar-se o mais depressa possível. É mais inquieto do que quer deixar transparecer e a energia que despende para esconder as suas preocupações pode minar sua saúde.
      O Sol em Leão indica um orgulho exacerbado. A natureza dominadora de Leão pode gerar dificuldades, tempestades decorrentes da própria força. Devem controlar a autoexigência e a vaidade excessiva, a prepotência, o medo de perder e de errar.
      Seu símbolo é associado à luz, portanto, o obscuro gera temor. Devem aprender a olhar e investigar o que existe por trás dos refletores para que possam complementar sua personalidade forte com mais fé e menos medo de falhar.
      O equilíbrio está no signo oposto, Aquário, que traz as lições de humildade, fraternidade, altruísmo, trabalho em equipe. Para tal, é necessário descer do seu próprio trono, servir à coletividade e conceder a liberdade na medida justa.`,
      ...
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
      As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
      A Lua no signo de Leão indica uma pessoa emocionalmente orgulhosa, com talento para artes dramáticas. Com frequência procura estar em evidência, pois há necessidade inconsciente de sentir‑se admirado e apreciado.
      Quem tem a Lua em Leão precisa de romance e afeto. Gosta de crianças, festas, arte, esportes, lazer e todo tipo de divertimento. Conta com disposição para se apaixonar, seja por uma pessoa ou por um projeto, abrindo o coração quando afetado pela sintonia do encontro.
      As emoções são intensas e algumas vezes agem com necessidade de dramatizar os sentimentos. Tem grande poder de expressão, pode usar seu brilho e seu magnetismo para impor sua vontade. Há tendência para o egocentrismo e, consequentemente, a teimosia.
      Há tendência também para dominar os outros, especialmente os que convivem no cenário doméstico. Pode aparentar ser uma fortaleza quando, na verdade, procura esconder suas fragilidades.
  ...
  },
  {
    ...
    text: [
      `Virgem é um signo do elemento Terra. Critério, discernimento e eficiência são palavras-chave. Com a energia prática do Sol em Virgem, pode aprimorar técnicas de trabalho, incrementar serviços, organizar a rotina, cuidar melhor da alimentação, da saúde, do equilíbrio do corpo e das emoções, em nome de mais qualidade de vida.
       ...
       Tende a preocupar-se com a saúde e sua boa forma física. Os pontos fracos do virginiano são: os intestinos, o fígado, o baço, o duodeno, o pâncreas e o sistema nervoso. Dedica atenção ao seu regime alimentar e se interessa por dietas.
       Graças ao seu comportamento alimentar, o virginiano raramente adoece. Contudo, se alguma doença ocorrer, há tendência para artrite, artrose ou problemas no aparelho gastrointestinal.
       Para se curar, o nativo deste signo deve buscar principalmente medicamentos suaves, homeopáticos, fitoterápicos e naturais. É aconselhável praticar esportes.
       É preciso cuidar para não se tornar crítico demais, cético e racional demais, cheio de manias ou até mesmo hipocondríaco. Ao julgar, classificar, compartimentar, pode ficar preso em detalhes e perder a visão do todo. Podem trabalhar demais e se esquecer do prazer.
       A vida pode ficar cinza, monótona e sem graça. É preciso cultivar autoestima. A magia, o encantamento, o romantismo, a imaginação, a fantasia, a transcendência e a espiritualidade estão lá do outro lado, em Peixes.
      ...
      `A Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
       ...
       É também tímido e reservado, prefere trabalhar tranquilamente nos bastidores. Presta muita atenção aos detalhes e deseja servir. Tanto o signo de Virgem quanto a Lua estão relacionados à fertilidade e fecundidade.
       Por isso, quem nasce com essa configuração gosta de cultivar boa qualidade em suas relações, cuidar do ambiente familiar e das pessoas mais queridas. Classificar os sentimentos traz segurança, que é abalada quando se defronta com emoções incompreensíveis e inomináveis.
       A objetividade e a praticidade são tendências visíveis. Não faz perguntas pessoais, a menos que seja necessário. É curioso, porém, somente em relação ao seu trabalho ou às questões práticas. Assim como costuma ser crítico consigo mesmo, também pode ser com os outros.
  ...
  },
  {
    ...
    text: [
       `Quando o Sol ingressa em Libra, marca o Equinócio da Primavera no hemisfério sul e o Equinócio de Outono no hemisfério norte.
        Equilíbrio entre o dia e a noite simboliza o ideal de Libra: a capacidade de ponderar as questões, de cultivar harmonia nas relações, bom gosto, educação, cordialidade e beleza. A balança coloca os dois lados de uma questão no prato para encontrar a justa medida entre ambas as partes.
        Libra é um signo de Ar regido por Vênus, cujos interesses são voltados para o amor e para a beleza. Representa a transformação do individualismo em cooperação, portanto, o libriano gosta de investir em parcerias. É uma alegria para o libriano participar do universo do outro, compartilhar o que é seu com os demais.
        Ser de Libra é andar de mãos dadas, conciliar, levar paz e tranquilidade onde há discórdia. O Sol em Libra concede também o sentido do grupo e um gosto evidente pela política, a justiça, a religião e a diplomacia.
        O nativo tem uma natureza sensível e refinada. Tem horror à grosseria em geral. Há grande possibilidade de várias uniões e sociedades durante a vida, o que pode trazer problemas ou processos ligados aos casamentos ou às associações.
       ...
       `A Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
        ...
        Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
        As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
        A Lua em Libra indica forte sensibilidade às atitudes e reações dos outros, especialmente os parceiros no casamento e companheiros de trabalho. Quem tem a Lua em Libra considera a vulgaridade desagradável. Conta com charme e elegância na sua aparência e maneiras pessoais.
        O senso estético é apurado. Sua casa geralmente é um lugar bonito e com frequência um local de reunião para atividades sociais. É amável, cordial, encantador e bondoso com todos, porque seu bem‑estar emocional depende da aprovação dos outros. Prefere ceder a enfrentar situações de conflito.
        Raramente age por impulso. Seus relacionamentos são pautados no equilíbrio, seus sentimentos são analisados de acordo com a razão. A indecisão pode ser fruto desse excesso de cuidado. Fica facilmente perturbado por relacionamentos desarmoniosos, que têm efeito prejudicial sobre a sua saúde.
       ...
       `O signo que se encontra no Ascendente indica a primeira impressão que causamos e a forma como iniciamos as coisas. O ascendente traz pistas sobre o aspecto físico, a "máscara" exterior (tanto física, como emocional e intelectual), alguns hábitos e maneirismos pessoais.
        ...
        Justamente por isso, pode ter dificuldade para lidar com circunstâncias que exigem decisões diretas e imediatas. Pode se sentir perdido quando tem de atuar sozinho e de escolher por si mesmo. A tendência é de se apoiar nos outros.
        Ao pesar na balança todos os lados de uma situação, pode ficar indeciso e vacilante. Em casos mais extremos degenera em sociabilidade exagerada, inércia, preguiça e dependência emocional. É mais fácil deixar outra pessoa decidir para si.
        Mas o desafio é desenvolver seu próprio sistema de valores, padrões e ideias sobre os quais possa fundamentar as iniciativas. Aprender a fazer suas próprias escolhas e se responsabilizar pelas consequências.
        Aprender a colocar suas necessidades de forma saudável, sem se tornar condescendente demais.
  ...
  },
  {
    title: `escorpiao`,
    text: [
      `Escorpião é um signo de Água regido por Plutão, o senhor das profundezas, associado á morte e ao renascimento. Escorpião trata dos mistérios, do que está oculto e obscuro, do que está latente, de tudo o que deve ser curado, regenerado, transformado.
       ...
       Os escorpianos devem aprender a olhar para o que deve ser transformado, nossas sombras, os lixos psíquicos, as questões que devem ser trabalhadas. Se não existisse a energia de Escorpião, o ser humano ainda estaria vivendo em cavernas.
       Por muito tempo Escorpião ganhou fama de maldito, vingativo, traidor, o pior dos signos. Mas, cá entre nós, um signo de fala de morte, tabus e coisas que insistimos em negar, realmente não iria ganhar boa fama. A grande lição de Escorpião é esta: PERDOAR. Soltar, desapegar, deixar ir...
       Trabalhar as emoções que ganham intensidade, com toques passionais. O antigo regente de Escorpião é Marte - há fogo por debaixo da água! O escorpiano deve lidar com forças transformadoras que o levam a enterrar o que está velho para que o novo possa nascer.
      ...
      `O signo que se encontra no Ascendente indica a primeira impressão que causamos e a forma como iniciamos as coisas. O ascendente traz pistas sobre o aspecto físico, a "máscara" exterior (tanto física, como emocional e intelectual), alguns hábitos e maneirismos pessoais.
       ...
       Esta turbulência emocional leva-o ao principal tema de Escorpião - o da morte e transformação. Como a cobra que muda de pele, o ascendente em Escorpião acumula a pressão até ocorrer uma explosão renovadora. Derruba e remove as velhas estruturas para que novas possam ser construídas.
       ...
       O desafio é levar a luz da consciência para aquilo que é obscuro e oculto dentro de si: emoções destruidoras tais como ciúme, inveja, avareza, luxúria ou ânsia de poder.
       Se essas emoções são reprimidas, elas fervilham por baixo, envenenam a psique e acabem sendo liberadas de forma desregrada. É importante reconhecer os sentimentos envolvidos, transformá-los, canalizá-los de forma mais construtiva.
  ...
  },
  {
    title: `sagitario`,
    text: [
     `A afirmação da individualidade é uma qualidade do elemento fogo. O sagitariano quer viajar, encontrar algo maior, filosofar, expandir fronteiras, cultivar liberdade de ação e pensamento, buscar mais espaço em todos os sentidos.
      Movido por este desejo, sua mente vai longe e explora territórios desconhecidos. Conta com grande potencial intelectual. Aprende que ao dominar o instinto, pode desenvolver a mente, elevar os ideais, expandir a fé, a consciência e o saber.
      ...
      Este é o significado da famosa seta apontada para o alto, símbolo do signo. O gosto pelo risco e a alma de aventureiro são característicos do signo. Quer aproveitar a vida ao máximo e pode viajar a qualquer lugar do mundo. Se pudesse, partiria num foguete para descobrir as estrelas e as galáxias.
      ...
      Com a idade pode desenvolver patologias que desenvolve afetam a parte inferior do corpo. Crises de ciática ou cãibras musculares, por exemplo. Pode também desenvolver alergias, que muitas vezes são resultado da sua alimentação demasiado rica e mal equilibrada.
      ...
      Aprender com as mudanças, olhar para outras culturas e religiões com respeito e humildade, adaptar os objetivos de acordo com as circunstâncias. Tudo em nome da evolução. De fato, a flecha apontada para o alto só atinge o alvo se o arqueiro possuir flexibilidade e habilidade nos movimentos.`,

     `A Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
      A Lua também representa nossos condicionamentos, a repetição de padrões de comportamento, os instintos que nos levam a ser reativos. O que nos afeta emocionalmente?
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
      As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
      A Lua no signo de Sagitário indica uma natureza emocional idealista e elevada. O nativo aspira a metas elevadas, porém, pode não possuir uma percepção muito realista da vida. Pode haver forte ligação com crenças religiosas ou filosóficas, incutidas pelos pais no início da vida.
      Quem tem a Lua em Sagitário é otimista, entusiasmado e alegre, raramente se acomoda, pois gosta de expandir suas fronteiras. Gosta de trazer mundos distantes para perto de si, viajar, movimentar-se com rapidez.
      Com frequência fixa suas raízes em países estrangeiros ou lugares muito afastados do local de nascimento.
      Há tendência para se identificar com certos valores sociais devido a razões emocionais, pessoais e inconscientemente motivadas. Por causa disso, não possuir objetividade no seu ponto de vista sobre questões sociais.
     ...
     `O signo que se encontra no Ascendente indica a primeira impressão que causamos e a forma como iniciamos as coisas. O ascendente traz pistas sobre o aspecto físico, a "máscara" exterior (tanto física, como emocional e intelectual), alguns hábitos e maneirismos pessoais.
      ...
      Tudo é analisado em relação e uma verdade maior. Seu entusiasmo e idealismo são contagiantes, inspiram as pessoas e contribuem para o bem-estar geral.
      ...
      Uma parte de sua natureza aspira nobres ideias, elevadas realizações e grandes alturas. Outra parte é dirigida pelas necessidades mais básicas e pelos instintos animais. O grande aprendizado é encontrar formas criativas para resolver essa diferença e encurtar essa lacuna.
      Quando deixa de lado a atitude de sabedoria pomposa e passa a compartilhar conhecimentos com humildade, dá um importante passo em direção à maturidade.
  ...
  },
  {
    title: `capricórnio`,
    text: [
      `Capricórnio é um signo de Terra que deve aprender a se esforçar para escalar sua própria montanha. Ambição é uma palavra-chave. O Sol em Capricórnio ajuda os nativos a brilhar através da competência no trabalho, do empenho e do empreendedorismo.
      Quando o Sol chega em Capricórnio, um ciclo se fecha e outro se inicia, com o solstício de verão no hemisfério sul e o solstício de inverno no hemisfério norte, evidenciando um assunto do signo de Capricórnio e de seu regente, Saturno: o tempo. Sem o controle dos calendários, nos sentiríamos perdidos.
      O capricorniano quer a realidade exposta e os limites mapeados. Prefere lidar com as emoções de forma mais racional e pragmática. Há tendência para se fechar em si próprio. Não é raro ver nativos deste signo solitários ou isolados do mundo.
      Predisposto a certa frieza em relação aos que o rodeiam. Pode parecer insensível, mas na verdade é mais introvertido e interioriza as suas emoções. Tem o senso de responsabilidade e de sacrifício quanto o objetivo é conquistar as metas desejadas.
      ...
      No corpo, os pontos vulneráveis são: os joelhos, as rótulas, os meniscos, as articulações, o esqueleto, a pele e os olhos. Com a idade, há tendência para desenvolver patologias nos ossos, na pele e problemas intestinais.
      É importante praticar exercícios de flexibilidade e alongamento para reforçar a sua estrutura óssea. Também exercícios respiratórios para aumentar a sua capacidade torácica. O desafio é não se tornar frio, rígido, tirano, duro, soturno (palavra quem vem de Saturno), ranzinza, crítico ou pessimista.
      É preciso aprender a lidar com as emoções sem represá-las, nem suprimi-las. O equilíbrio está no signo oposto, Câncer, com suas lições de carinho, afeto, cuidado e acolhimento. Ao se identificar emocionalmente com os outros, não abusa do poder.`,

      `A Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
      A Lua também representa nossos condicionamentos, a repetição de padrões de comportamento, os instintos que nos levam a ser reativos. O que nos afeta emocionalmente?
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
      As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
      A Lua no signo de Capricórnio indica uma natureza reservada e cautelosa, inclinada à frieza e à austeridade. O nativo procura racionalizar os sentimentos, prefere agir ao invés de falar sobre as emoções.
      Leva a vida a sério e se identifica emocionalmente com valores materiais, em detrimento dos valores espirituais. Nascer com a Lua em Capricórnio é ser trabalhador, exigente e ambicioso. Mas suas ambições possuem uma tendência pessoal, voltada ao status e à segurança financeira.
      ...
      Há tendência para timidez e insegurança a respeito de seu próprio valor. Pode ser sensível à falta de consideração, real ou imaginária. Por causa disso, procura se justificar pela dignidade pessoal e ambição para vencer.
  ...
  },
  {
    ...
    text: [
     `Aquário é um signo de Ar, visionário, inteligente, inovador e pioneiro, que gosta de pensar no coletivo. Gosta de olhar para o futuro, de questionar regras, dogmas e tabus obsoletos.
      O Sol em Aquário inspira o olhar vanguardista, a liberdade, a igualdade e a fraternidade.  Gosta de pensar no coletivo, mas também preza a individualidade. A ideia é essa: cada um com sua personalidade e seus talentos únicos colaborando para o sucesso do conjunto.
      O aquariano cultiva o entendimento de que somos parte de um todo que se organiza de acordo com uma ordem, que devemos enfrentar os problemas sociais e apresentar soluções. Aquário é um signo mental, não tem muita paciência para pequenos sentimentalismos. Está mais inclinado para grandes causas e ideais.
      É regido por Urano, um planeta de energia revolucionária. Tem grande imaginação, inventividade, dificuldade de aceitar imposições e alimenta um desejo permanente de renovação. Tem um quê de rebelde e excêntrico, pode se sentir muitas vezes incompreendido e indignado com as injustiças sociais.
      O grande desafio do aquariano é transformar essa rebeldia, tornando-se um revolucionário que consegue quebrar com velhos padrões e trazer as novas ideias para a realidade. Deve aprender a ter mais paciência com o tempo das coisas, pois seu raciocínio é veloz.
      ...
      Aquário é irreverente, anda na contramão do senso comum e necessita ser radical para ser ouvido. Mexe com preconceitos arraigados, deixa marcas de sua passagem como um vendaval no quintal.  Não tolera qualquer aprisionamento, ou qualquer rotina.
      ...
      Com a idade, há tendência para patologias relacionadas à má circulação sanguínea. Deve também vigiar os rins, o coração e os nervos. O melhor remédio para o aquariano é a atividade e a distração. Quando está com a mente ocupada, está feliz e não tem tendência para pensar em coisas tristes.
      ...
      Os aquarianos devem se conectar com seu coração para sentir que a vida é única. Isso sem dúvida vai ajudá-los a se relacionarem mais intimamente, a compreenderem que os objetivos e anseios pessoais podem ser tão nobres quanto os anseios universais.`,

      `A Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
      A Lua também representa nossos condicionamentos, a repetição de padrões de comportamento, os instintos que nos levam a ser reativos. O que nos afeta emocionalmente?
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
      As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
      Nascer com a Lua no signo de Aquário é contar com capacidade para compreender as necessidades da humanidade. É buscar a liberdade de expressão emocional e exigir liberdade de movimentos dentro do cenário doméstico.
      É provável que as relações familiares sejam incomuns. O seu lar pode ser um local de reunião para amigos e atividades em grupo. A Lua em Aquário pode proporcionar lampejos de conhecimento intuitivo.
      Os cuidados e os interesses se voltam para a coletividade, as amizades, as novidades, o convívio social, a participação ativa em ações humanitárias. Novas relações são sempre bem-vindas. Mas há pouca habilidade para lidar com sentimentalismos.
      A Lua em Aquário pode proporcionar também reações emocionais imprevisíveis, uma tendência à perversidade emocional e à teimosia, ou uma inquietação e necessidade irracional de liberdade a qualquer custo.
  ...
  },
  {
    title: `peixe`,
    text: [
     `Peixes é o último signo do Zodíaco, o RELIGARE. É um signo que trata de assuntos transcendentais, cuja grande lição é dissolver o ego para cultivar a compaixão, desenvolver a fé, aprender a entregar o controle da vida para uma Força Maior.
      ...
      Peixes ensina que a vida tem um significado maior, além da matéria. Quer dar asas à imaginação, sonhar, fantasiar, cultivar encantamento e magia. Peixes é teatro, poesia, música, cinema, fotografia, glamour, poesia, fantasia, imaginação. A fábrica dos sonhos.
      As imagens que falam mais que mil palavras. Tudo o que trás um significado pra vida, que eleva. A missão superior de Peixes é aprender a estabelecer contato com a alegria espiritual, para que possa partilhá-la com todos aqueles que você conhece.
      Uma das características do pisciano na qual se repara à primeira vista é o seu olhar e os seus cabelos, pois tem tendência para olhos grandes e uma cabeleira espessa. Seu mundo interior é muito rico. É um sonhador que vive perdido num mundo misterioso que lhe pertence e que só ele vê.
      ...
      No corpo, as partes vulneráveis são: as vias respiratórias, o sistema imunológico, sistema linfático, os pés, a digestão e o psiquismo. Com a idade, há tendência para crises de angústia e doenças virais como gripes e outras.
      Se não se alimentar bem, terá tendência para desenvolver problemas de digestão e assimilação, o que favorece a emergência de certas alergias e problemas na pele. Tem também fragilidade no domínio hormonal e endócrino.
      ...
      Os enganos, a loucura, a falta de objetividade, o sacrifício, a sensibilidade excessiva que causa sofrimento, a vítima, a religiosidade distorcida. O descontrole, a esquizofrenia, a boemia, o isolamento, o claustro. Deve tomar cuidado com as drogas e a bebida.
      ...
      `Signo 2 Lorem ipsumA Lua representa a forma como vivemos as nossas emoções. É o que já é familiar, conhecido, nossa zona de conforto, onde buscamos nutrição emocional. O que é que precisamos para nos sentirmos seguros?
      A Lua também representa nossos condicionamentos, a repetição de padrões de comportamento, os instintos que nos levam a ser reativos. O que nos afeta emocionalmente?
      Para a Astrologia Cármica, a Lua representa a memória do passado do passado: infância, ancestralidade, hereditariedade e vidas passadas. Já o Sol representa o futuro.
      As qualidades do signo solar indicam um caminho de cura para equilibrar as questões relativas à Lua. Por isso, a Lua deve estar ao serviço do Sol, sendo um canal de expressão da vontade solar.
      Nascer com a Lua no signo de Peixes é ser dotado de uma natureza emocional hipersensível. Assim, pode ser como uma esponja psíquica, que absorve os pensamentos e as emoções dos outros. É bondoso, intuitivo e compreensivo, devido à sua sensibilidade aos sentimentos alheios.
      Entretanto, pode se magoar facilmente e desenvolver um complexo de perseguição. Essa sensibilidade extrema pode fazer com que se sinta psicologicamente vulnerável e até mesmo se afaste ou se isole, para que possa se proteger emocionalmente.
      A Lua em Peixes indica uma imaginação ativa, criativa e inspirada, que pode resultar em manifestações poéticas, musicais ou artísticas. O nativo é sonhador e costuma viver com os pés longe do chão, já que é nas alturas que busca sua inspiração.
     ...
     `O signo que se encontra no Ascendente indica a primeira impressão que causamos e a forma como iniciamos as coisas. O ascendente traz pistas sobre o aspecto físico, a "máscara" exterior (tanto física, como emocional e intelectual), alguns hábitos e maneirismos pessoais.
      ...
      `Signo 11 Lorem ipsum`,

      `Signo 12 Lorem ipsum`,

      `Signo 13 Lorem ipsum`,

      `Signo 14 Lorem ipsum`,

      `Signo 15 Lorem ipsum`
    ],
    levels: [
        `Níveis evolutivos da alma (reflita para perceber em que nível está):`,
  ...
  casas: [{
    title: `Casa 1`,
    text: [
       `Quando o Sol está no ascendente, o nativo sente que o ambiente da sua primeira infância apoia seus desejos e ela consegue expressar sua individualidade de maneira espontânea. Há forte impulso para ser notado, respeitado e reconhecido pelos outros, além da tendência de se colocar como líder.
        É essencial que se assuma a responsabilidade de revelar seu próprio caminho na vida, determinando de forma clara o que deseja obter e perseguir essa visão com persistência e determinação. Esse posicionamento indica grande carisma, criando um temperamento animado e dando vitalidade física se não houver aspectos tensos.
        Geralmente persegue o sucesso pessoal. Mas o principal desafio é cruzar o abismo entre os sonhos infantis de ser especial e importante e o nível superior das verdadeiras realizações, para que seja único e importante em sua contribuição criativa no mundo.
     ...
     `Indica necessidade de uma casa, do ambiente doméstico e da família e pode se sentir infeliz se morar sozinho ou se perder da família.
      ...
      Tem apurada sintonia com o corpo, sabe quando está ficando doente e as mudanças de humor podem dominar a personalidade. Pode se sentir atraído por profissões ou hobbies que envolva alimentar ou nutrir outras pessoas.`,
  ...
  },
  {
    ...
    text: [
      ...
      Será através da utilização consciente desses recursos internos que ela poderá desenvolver um senso de identidade única e atrair os recursos materiais necessários para a realização de seus talentos. É necessário um esforço consciente para definir as verdadeiras necessidades e valores.
      ...
      O nativo tem clareza na questão da subsistência. Compreende a importância do que é ganhar o próprio sustento e produzir algo. Sabe que a vida não é só planejar e sonhar, mas também realizar, deixar algo de concreto, cultivar seus valores e se distinguir através deles.
  ...
  },
  {
    title: `Casa 3`,
    text: [
     `Os potenciais do Sol na casa 3 são revelados através do desenvolvimento mental, intelectual e da habilidade para se comunicar. O prazer e o estímulo para ser único virão da troca de ideias, criando preciosas perspectivas pessoais.
      É necessário um empenho e uma responsabilidade pessoal para que o potencial de clareza e eloquência intelectuais se desenvolva. Assim o nativo consegue iluminar conscientemente suas relações e comunicação pessoal.
      A mente do nativo com o Sol na casa 3 tende a manifestar uma atitude curiosa, voltada à exploração do mundo. Há uma necessidade interna, nem sempre compreendida, de entender os processos de funcionamento da vida como um todo.
      ...
      A vida para o nativo é troca, é se relacionar com o que está próximo, é ver o que está ao redor, conversar com quem estiver perto, saber o que está acontecendo. Ele crê que é preciso participar do mundo imediato e a sua vitalidade é ampliada por ele.
  ...
  },
  {
    title: `Casa 4`,
    text: [
      `Na casa 4, a procura da própria identidade passa pelas raízes, pelas heranças familiares, pelos padrões ancestrais e a vida em família. É exigida do nativo uma iluminação consciente dos padrões emocionais, através da investigação e integração interiores.
      ...
      O nativo guarda um sentimento de clã e de família e, quando gosta de alguém, aquela pessoa passa a fazer parte do seu mundo. Possui o dom do acolhimento e de tornar especial o local em que vive. Seu interior é aconchegante e pode iluminar a vida íntima, o convívio familiar. `,

      `A quarta casa é a morada natural da Lua devido à associação com o signo de Câncer, regido pela Lua. Há tendência de buscar autonomia no trabalho, preferindo realizar uma atividade em casa, num negócio próprio.
      ...
      Pode ter pouca confiança em si mesmo devido a problemas na infância. Precisa de amor e afeto, por isso deve evitar pessoas destrutivas que podem magoá-lo. Tem simpatia pelos fracos e desamparados e um amor especial pelos animais.
      Pode se sentir atraído pelo passado e se dedicar a profissões que lidam com antiguidades, ancestralidade, memória ou que guarde valores, como também pode gostar de colecionar. Tem forte impulso de viver e gosta de estar perto do mar.`,
  ...
  },
  {
    ...
    text: [
      ...
      A produção artística, sob forma intelectual, emocional ou material, são importantes para a auto expressão e também um canal das energias do Sol. Esse posicionamento solar cria emoções ardentes, intensidade e alegria de viver.
      ...
      A motivação está em empreender sua aventura na busca de satisfação pessoal, em seguir o caminho do coração. Como acaba se sobressaindo por puro entusiasmo, corre o risco de criar personagens que agradam ao público e mascarar sua individualidade em busca de aplausos.
      ...
      O nativo deve aprender a ser livre e participar inteiramente da vida. Compreender que a vida também é diversão e gratificação. Cultivar a alegria da criança interior, sempre em busca de um desafio, de algo criativo para ser realizado.
      Quer amar com entusiasmo e ser amado. Sabe que na vida é preciso deixar uma marca e a vida sempre precisa ser um show.`,

      `Vivem fortes emoções e procura satisfação romântica ou prática, podendo ter inúmeros casos amorosos. Sente atração pelo mundo jovem e infantil, por isso tende a se atrair por profissões que envolva crianças e jovens, especialmente na área de educação, lazer ou atividades esportivas.
      ...
      Tem forte apego e amor aos filhos. Ter um canal de expressão criativa é uma necessidade emocional, por isso pode desejar ter filhos ou se apega a animais de estimação. Há o instinto para criar nas artes em geral e pode se tornar um bom professor, apresentador, escritor ou editor.`,
  ...
  },
  {
    title: `Casa 6`,
    text: [
     `Na casa 6, a direção na vida e o senso de realização podem ser descobertos através do serviço que presta e dos cuidados com a saúde e dieta. Dedicando a essas áreas ajudará na definição de seu senso de identidade única, pois proporcionará canais para uma expressão pessoal.
      ...
      O Sol na casa 6 faz com que o nativo busque desenvolver suas habilidades e competência, de modo a ocupar um lugar ativo no mercado de trabalho. Assim desenvolve um sentido de valor pessoal e de distinção.
      O objetivo não é apenas ganhar aplausos, mas criar luz própria. A consciência de si mesmo será desenvolvida na arte de viver um dia após o outro, o que poderá ser feito com tanto gosto e sutileza que causará admiração. Sua grandeza está na simplicidade.
      É um artista do cotidiano, da rotina, das pequenas coisas, nas quais vê graça e deixa a sua graça, seu humor, sua vitalidade. Brilha naquilo que faz e sabe que tem de se colocar inteiro nas suas tarefas, no seu trabalho. Usar todos os seus recursos e suas habilidades na realização de um Serviço.`,
     ...
     `Indica a necessidade e o forte impulso para cuidar e suprir as necessidades dos outros, por isso pode trabalhar em alguma profissão assistencial, enfermagem ou na medicina.
      ...
      É importante que se envolva emocionalmente com o trabalho. Pode ser extremamente paternalista com os colegas de seu convício diário. Portanto, pode desistir de um emprego por não se adaptar ao ambiente ou aos colegas de trabalho.
      Talvez trabalhe como prestador de serviços ou em empregos sem horário fixo ou para várias empresas. É preciso cuidado com a tendência para a crítica, autocrítica ou perfeccionismo. A satisfação emocional está ligada à busca de qualidade e aprimoramento. `,
  ...
  },
  {
    title: `Casa 7`,
    text: [
    `O Sol na casa 7 leva ao desenvolvimento através dos relacionamentos, das associações e das parcerias amorosas ou sociais. A participação em atividades conjuntas permite canais de expressão para sua individualidade.
      O processo do Sol na casa 7 se inicia com o encontro de alguém que serve de referência para a própria modelagem. Posteriormente o nativo acrescenta as forças e qualidades inatas através de sua participação ativa na interação social.
      Há o perigo de evitar o próprio desenvolvimento e se esconder atrás da identidade de outra pessoa. Procurar alguém grande e forte que lhe diga o que deve fazer de sua vida, como uma tentativa de viver o princípio solar através do outro.
      ...
      Assim pode aprender a ser único com a ajuda de parceiros e colaboradores, fazendo com que todos que a ele se associem possam brilhar também. Sua arte está nas habilidades sociais. O nativo entende que ninguém é uma ilha, que as pessoas têm impacto umas sobre as vidas das outras.
      Pode desenvolver a política e a diplomacia, a arte do desvio, mas também do enfrentamento. Entrando em contato com o outro, encontra a si mesmo e consegue ver o outro com maior clareza, mais do ninguém.`,
     ...
     `Indica a necessidade de companhia e companheirismo, por isso se dedica para agradar aos outros ou para salvar um relacionamento, mesmo que tenha de abdicar de seus próprios interesses.
      ...
      Pode se dedicar a algum trabalho assistencial para garantir a justiça ou gerência de pessoal, onde predomina a imparcialidade. Sente o apelo do glamour e pode se atrair para o mundo da moda, do design e da música, que também pode ser um hobby.`,
  ...
  },
  {
    title: `Casa 8`,
    text: [
     `Os relacionamentos que expõem paixões ocultas e esbarram em emoções primárias não resolvidas fazem parte do processo de desenvolvimento do Sol na Casa 8. Há um grande interesse por tudo que está oculto ou é misterioso e a vida se mostra de forma intensa.
      Às vezes pode temer a intensidade de seus sentimentos, resistindo a uma compreensão mais profunda de si mesmo e rejeitando o próprio potencial de transformação. É necessário que desenvolva coragem para explorar os porões da mente e os segredos da vida.
      Então as tensões se dissolvem através da autoexpressão consciente. Os relacionamentos deixam de ser um campo de batalhas e se tornam a base para o crescimento e para o prazer. A união traz potencial de cura, crescimento e autodesenvolvimento.
      Para que esse Sol brilhe, o nativo deve valorizar o desejo de se unir a algo maior que si mesmo, através do amor e da fusão com outro ser humano. Com esse objetivo, aprende a se expandir e transcender seus limites emocionais, deixando para trás o separatismo e o isolamento que o desvitalizam.
      O nativo que tem o Sol na Casa 8 pode buscar tudo aquilo que é profundo, ver sempre o que há por dentro, o âmago de qualquer questão. Tem facilidade para descobrir coisas e dar diagnósticos, pois vive sempre atrás do que do que é oculto ou disfarçado.
      Entende a arte da intimidade, dos vínculos profundos, dos quais não tem medo. Conhece os sentimentos mais turbulentos e as perdas, mas também o renascimento. Sempre se redescobre cada vez que morre e é obrigada a renascer. Muitas vezes, perde para poder ganhar.`,

     `Perspicaz ao extremo, entretanto a forma de usar essa qualidade depende de outros fatores do mapa. O amor apaixonado, a sensualidade e o sexo são fatores importantes na vida e os maiores êxitos podem ser obtidos através de alguém que proporcione inspiração mental e sexual.
      A Lua nessa posição aumenta o comportamento instintivo e reativo. É preciso cuidado com a desonestidade ou as reações emocionais exacerbadas ao se sentir ameaçado, que podem prejudicar a carreira e as chances de sucesso.
  ...
  },
  {
    ...
    text: [
     `Ao aumentar a compreensão e a perspectiva da vida através de viagens, leituras ou pesquisas filosóficas, o Sol na casa 9 se vitaliza e potencializa.
      ...
      É através da busca de sabedoria que o nativo ganhará inspiração. O que aprender em seu caminho deve ser ensinado e compartilhado, pois esse conhecimento também será útil para os outros e só terá significado real se puder ser passado para frente.
      O grande aprendizado é no sentido de conseguir vivenciar a filosofia e os grandes significados da vida na realidade do aqui-agora. Assim as descobertas dos aspectos mais abstratos da vida podem orientar seus compromissos pessoais e iluminar a vida mais mundana.
      A vida jorra do conhecimento e é ali que esse Sol vai buscá-la, transitando com facilidade entre conceitos abstratos, linguagens simbólicas, diferentes culturas, princípios ou leis. O nativo descobre que a vida é expansão e por isso quer viajar, está sempre se aventurando.
      Compreende que a alma precisa ir longe, pois é do longínquo que volta reabastecida. Sabe que não é possível ficar apenas com experiências conhecidas, pois só podemos crescer ao sair da área de segurança.`,
     ...
     `A Lua nessa posição indica uma natureza inquieta e nômade que não cria raízes. O nativo está sempre andando pelo mundo ou diversificando interesses.
      ...
      É psíquico por natureza, capaz de ver e sentir além das fronteiras do mundo material. As viagens ao exterior, o contato com estrangeiros ou com mercadorias importadas podem ter muita importância na vida ou no trabalho.
  ...
  },
  {
    ...
    text: [
     ...
     `A Lua na casa 10 proporciona o impulso interior para brilhar de alguma forma diante do público ou de ajudar a humanidade numa escala grandiosa. Pode ter uma carência marcada por acontecimentos desagradáveis na infância.
  ...
  },
  {
    title: `Casa 11`,
    text: [
     `O Sol na Casa 11 se desenvolve através da participação num grupo, na busca contínua de progresso social e cultural. A consciência se volta para a interação entre o individual e o coletivo, com grande sensibilidade para os sofrimentos injustos de homens, animais e da natureza.
      Isso faz com que a criatividade ao longo do tempo acabe se vinculando à consciência pública e às soluções alternativas para os conflitos sociais. As amizades tem grande importância para o desenvolvimento da personalidade.
      Os esforços para construir a própria identidade estão vinculados às suas aspirações e metas coletivas. É importante que os nativos com o Sol na Casa 11 façam um esforço consciente para estabelecer metas praticáveis quando se sentem inspiradas.
      Esse esforço para a realizações concretas permitem um sentido de identidade, propósito e poder. O mais importante ingrediente para a própria realização e a própria cura é ter uma razão para viver, criando uma função pessoal e interiormente ditada.
      ...
      O nativo sabe que uma das maiores riquezas da vida são os amigos. Nunca se sentirá sem rumo se tiver amigos. Sabe que todos nós estamos interligados. Sabe que o destino de uma pessoa não está desvinculado do destino de outros. Vive os fatos e a cultura do seu tempo e com certeza participa dele.
     ...
     `A Lua nessa casa indica necessidade de companhia de amigos ou participação em clubes e grupos. Porém gosta de cultivar independência e não tolera restrições.
      ...
      Nutre um forte sentimento de solidariedade, pode se envolver em projetos ligados a causas sociais ou organizar movimentos em grupo. Porém, pode cometer erros de julgamento e ser enganado por gente astuta.
  ...
  },
  {
    ...
    text: [
     `Quando o Sol ocupa a casa 12 há um paradoxo, pois o Sol estabelece, esclarece e desenvolve uma identidade separada e única e a casa 12 trabalha no sentido de dissolver, desestruturar e subverter as fronteiras individuais.
      Há um conflito que requer da pessoa o desenvolvimento do sentido de identidade para além da conscientização normal: o ego e a vontade tem que desempenhar seu papel de servidor da alma, das causas espirituais. O Sol representa o consciente e a casa 12 é a casa do inconsciente.
      Na jornada da casa 12, o nativo deve aprender a manejar o limite sutil entre o que é pessoal, individual e consciente, e o que é universal, coletivo e inconsciente. Isso significa ter que gastar muito tempo consigo mesmo, com meditações, retiros, vivências espirituais e mergulhos na alma.
      Durante o processo de formação do ego, há uma luta feroz para impedir a entrada de qualquer coisa mais vaga, irracional, mística ou transpessoal. Mas, quando chega à noite, tudo o que foi afastado da consciência invade os espaços e geralmente sob formas assustadoras.
      ...
      Só quando aceita conscientemente as correntes inconscientes, buscando uma expressão criativa para essas forças, será possível a esse Sol a sua realização. Isso implica uma coabitação entre o pessoal e o universal, uma profunda conexão com a Fonte Universal.
      A pessoa se dissolve no mistério da vida, compreendendo que é parte do Universo. Por isso não separa a vida em escaninhos. Percebe que está tudo interligado, que nada acontece por acaso e que a frente de algo pode ser os fundos de outra coisa.
      Sua compreensão tende a ser um pouco mais larga do que a de outras pessoas, porque abrange dimensões mais sutis. Não é algo que apareça em sua linguagem, mas que se reflete bastante em suas atitudes, em coisas que acaba fazendo e muitas vezes nem sabe por quê.
      Muitas vezes vê o que ninguém viu e vice-versa, o que é claro para os outros pode não ser óbvio para si.`,

     `A Lua nessa casa indica tendência para se esconder ou se isolar do mundo. O nativo pode se sentir mais feliz quando cuida de si e da própria vida, quando trabalha e fica dentro de casa. Há uma forte ligação com a mãe.
      O nativo é discreto, misterioso e cultiva alguns segredos em sua vida. É possível que trabalhe em uma área que precise guardar segredos de outras pessoas e nas relações sociais, pode ser considerada apta a compartilhar de seus segredos.
      É muito sensível e intuitivo, seu universo interior é muito rico. A imaginação abastece a criatividade, que pode levar a criações poéticas, musicais e artísticas. Há necessidade de se isolar do mundo para recarregar as energias, pois o stress pode resultar em doenças.
