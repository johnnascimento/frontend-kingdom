      ...
      fixedTexts: {
            planets: [
                  ...
                  },
                  {
                        ...
                        Esse astro representa a maneira como você expressa a sua natureza mais essencial, o seu eu na forma mais básica.
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Orgulho, arrogância, vaidade, autoconfiança excessiva, autoritarismo e presunção.`
                  },
                  {
                        Lua: `<span class="subTitle">LUA: </span>
                        A Lua é o astro relacionado às questões emocionais. Ela mostra como você lida com a sua sensibilidade e as reações emotivas que você tem diante da sua vida.<br /><br />
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Preguiça, irracionalidade, inconstância, indecisão, rege as instabilidades, os humores, teimosia e timidez.`
                  },
                  {
                        mercurio: `<span class="subTitle">MERCÚRIO: </span>
                        Esse é o planeta da razão. Mercúrio está relacionado a tudo que envolve o raciocínio e a inteligência humana. É também o astro da comunicação e do comportamento mental. Ele revelará a forma como você se expressa.<br /><br />
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Inveja, tendência a trapacear, cinismo, descontrole nervoso e capacidade crítica exacerbada.`
                  },
                  {
                        venus: `<span class="subTitle">VÊNUS: </span>
                        Esse planeta é o representante da beleza e do amor. Ele mostra a sua forma de lidar com o amor e com a feição. Mostra onde se encontra os valores que você dá as coisas e as pessoas e como você enxerga o belo.<br /><br />
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Regente da luxúria, das paixões carnais desenfreadas, amoralidade e da incapacidade de se lidar com os impulsos sexuais e a sensualidade.`
                  },
                  {
                        marte: `<span class="subTitle">MARTE: </span>
                        Marte mostra o seu relacionamento com as questões que exigem esforço e conquista. Como você lida com a sua força? Ele vai mostrar como funciona o seu espírito de luta.<br /><br />
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Ira, impulsividade, agressividade, brutalidade, egoísmo, espírito vingativo, instinto destrutivo e ambição.`
                  },
                  {
                        jupter: `<span class="subTitle">JUPTER: </span>
                        A forma como você vai buscar um sentido para a sua existência é representada por Júpiter. Esse planeta revela as questões relacionadas a oportunidades, crescimento pessoal e objetivo de vida.<br /><br />
                        ...
                        <span class="highlighted">Aspectos negativos</span>: Gula, ambição, arrogância, megalomania e autoindulgência.`
                  },
                  {
                        saturno: `<span class="subTitle">SATURNO: </span>
                        A representação das suas inseguranças e valores morais é representada por Saturno.<br /><br />
                        ...
                        Deste modo, encerra-se o <strong class="highlighted">Septenário Astrológico</strong>, determinado por muitos autores como uma fase ou ciclo.<br /><br />
                        ...
                        Do oitavo planeta em diante, os chamados <strong class="highlighted">transsaturninos</strong>, inicia-se uma nova série que representa outro ciclo mais elevado de influências astrais.<br /><br />
                        Assim, temos uma trilogia intimamente ligada às forças que constantemente impelem à mudança psicológica e a transformação que nos leva ao desenvolvimento.`
                  },
                  {
                        urano: `<span class="subTitle">URANO: </span>
                        Urano representa a revolução e o nosso espírito de mudança. Em quais áreas você expressa sua originalidade? Aqui é mostrada a sua sede pelo novo, pelo desconhecido e também onde reside a sua confusão mental e contradições.<br /><br />
                  ...
                  },
                  {
                        ...
                        As relações com a espiritualidade são mostradas em Netuno. Até que ponto as ilusões que criamos são realmente crenças?<br />
                  ...
                  },
                  {
                        ...
                        Representa a forma como você lida com as questões relacionadas à morte e ao renascimento.<br /><br />
                        ...
                        Sendo assim, Plutão representa também, o impulso vital em busca da forma. Marcando os passos evolutivos da nossa humanidade.`
                  }
            ],
            houses: [
                  {
                        title: `Astrologia | O significado das casas`
                  },
                  {
                        subtitle: `- A importância das casas astrológicas: angulares, sucedentes e cadentes.`
                  },
                  {
                        casasAngulares: `<span class="subTitle">Casas angulares: </span><em class="highlighted">1, 4, 7 e 10.</em>
                        A palavra "angular" aqui se refere aos ângulos principais, as quais são: a primeira, quarta, sétima e décima casa. A palavra-chave para as casas angulares são o "Eu". <br /><br />
                        Nesse caso, o "Eu" significa "O Ego". As casas angulares nos dizem como lidar com a realidade e como começamos as coisas.`
                  },
                  {
                        casasSucedentes: `<span class="subTitle">Casas sucedentes: </span><em class="highlighted">2, 5, 8 e 11.</em>
                        A palavra "sucedente" significa "seguir" ou "alcançar" (ou meios para se seguir ou alcançar o sucesso). As casas sucedentes são: a segunda, quinta, oitava e décima primeira.<br /><br />
                        ...
                        E tudo isso pode ser um prazer, pois você pode desfrutar de suas aquisições. Este é o ciclo! As casas sucedentes estão ligadas aos signos fixos.`
                  },
                  {
                        casasCadentes: `<span class="subTitle">Casas cadentes: </span><em class="highlighted">3, 6, 9 E 12.</em>
                        Cadente nesse caso significa "queda", "chegar ao fim" ou "resolução". As casas cadentes são a terceira, sexta, nona e décima segunda. A palavra-chave para cadente é "dispersão". Um dos significados de dispersão é "dar" ou "doar".<br /><br />
                        ...
                        Na astrologia, significa pensarmos sobre o passado e o futuro de uma forma mais ou menos crítica, detalhada e impessoal, com a intenção de usar o que aprendemos para dar os nossos próximos passos na vida.`
                  },
                  {
                        casaUm: `<span class="subTitle inline">CASA 01 | </span><em class="highlighted">casa angular:</em>
                        Aparência Pessoal, da Primeira abordagem e das situações da vida.<br />
                        ...
                        Por exemplo, se vênus está na primeira casa, temos a tendência a nos apresentar de uma forma harmoniosa e diplomática.`
                  },
                  {
                        casaDois: `<span class="subTitle inline">CASA 02 | </span><em class="highlighted">casa sucedente:</em>
                        Valores e do Dinheiro e como você lida com ele e seus Recursos.<br />
                        <strong>A segunda casa é muitas vezes associada à riqueza, de bens pessoais.</strong><br /><br />
                        Naturalmente, o que acumulamos depende do valor que atribuímos. A segunda casa se preocupa com o que nós damos valor, incluindo nós mesmos e a nossa autoestima, assim, como também o que ganhamos.`
                  },
                  {
                        casaTres: `<span class="subTitle inline">CASA 03 | </span><em class="highlighted">casa cadente: </em>
                        Pensamentos, Aprendizagem, Comunicação e dos Irmãos.<br />
                        ...
                        Este não é um conhecimento profundo, no qual é a preocupação da nona casa, e sim simplesmente fatos e informações. Literatura e comunicação verbal se ressaltam.`
                  },
                  {
                        casaQuatro: `<span class="subTitle inline">CASA 04 | </span><em class="highlighted">casa angular: </em>
                        Passado, da influência familiar, do Lar e dos Cuidados Recebidos.<br />
                        <strong>A quarta casa é a da família, ou o "eu" em relação à família</strong>, significa o ego que criamos a partir do passado, as origens genéticas, a memória, o autodesenvolvimento, etc.`
                  },
                  {
                        casaCinco: `<span class="subTitle inline">CASA 05 | </span><em class="highlighted">casa sucedente: </em>
                        Criatividade, dos Filhos, da Recreação e do Namoro.<br />
                        <strong>A quinta casa, muitas vezes refere-se a prazeres, que são o resultado de alguma atividade.</strong><br /><br />
                        Preocupa-se com amor e romance, assim como todos os tipos de entretenimento, incluindo quaisquer jogos e esportes. Também diz respeito a crianças.`
                  },
                  {
                        casaSeis: `<span class="subTitle inline">CASA 06 | </span><em class="highlighted">casa cadente: </em>
                        Saúde, do Trabalho e da sua Atitude diante deles.<br />
                  ...
                  {
                        casaSete: `<span class="subTitle inline">CASA 07 | </span><em class="highlighted">casa angular: </em>
                        Casamento e outras Relações de Compromissos.<br />
                        <strong>A sétima casa é o "eu" em relação aos outros</strong> (interpessoal).`
                  },
                  {
                        casaOito: `<span class="subTitle inline">CASA 08 | </span><em class="highlighted">casa sucedente: </em>
                        Morte e Renascimento, do Sexo, da Reprodução e da Cura.<br />
                        <strong>A oitava casa às vezes se refere aos recursos compartilhados, incluindo heranças.</strong><br /><br />
                        <strong>Também tem a ver com o sexo, regeneração</strong> e a rapidez com que você pode se recuperar de uma doença, etc. Trata da saúde, do dinheiro de outras pessoas e dos valores sociais.`
                  },
                  {
                        casaNove: `<span class="subTitle inline">CASA 09 | </span><em class="highlighted">casa cadente: </em>
                        Filosofia, da Vida, da Expansão da Consciência, do Saber, do Autoconhecimento e da Educação Superior.<br /><br />
                        ...
                        Aqui nós pensamos muito profundamente sobre as coisas, tomando viagens mais longas a fim de adquirir o conhecimento.`
                  },
                  {
                        casaDez: `<span class="subTitle inline">CASA 10 | </span><em class="highlighted">casa angular: </em>
                        Carreira, da sua Autoridade e da sua Posição no Mundo.<br />
                        <stronng>A décima casa é o "eu público"</stronng> (fama, notoriedade), ou o "eu" visto pelas pessoas.`
                  },
                  {
                        casaOnze: `<span class="subTitle inline">CASA 11 | </span><em class="highlighted">casa sucedente: </em>
                        Amigos, dos Grupos e da sua Transformação Social.<br />
                        <strong>A décima primeira casa refere-se aos amigos e grupos, que foram "colecionados".</strong><br /><br />
                        Também se preocupa com as esperanças e desejos que nós temos. Está preocupada com o futuro, e tais preocupações também envolvem os valores que esperamos que a sociedade adote.`
                  },
                  {
                        casaDoze: `<span class="subTitle inline">CASA 12 | </span><em class="highlighted">casa cadente: </em>
                        Espiritualidade, do Comportamento Secreto e do Inconsciente.<br />
                        ...
                        Indica também áreas onde temos inimigos secretos, que podem ser até mesmo certos aspectos de nós mesmos, aqueles que agem como sabotadores subconscientes que podem nos levar a nossa ruína.`
                  }

            ],
            observation: [
                  {
                        info: `- Neste estudo interpretamos as possibilidades de cada planeta em cada signo e em cada casa do seu mapa. Aqui você tem um excelente material para autoconhecimento.<br /><br />
